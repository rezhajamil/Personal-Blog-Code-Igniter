...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Tbl_balas_komentar <?php echo $button ?></h2>
        <form action="<?php echo $action; ?>" method="post">
	    <div class="form-group">
            <label for="int">Id Komen <?php echo form_error('id_komen') ?></label>
            <input type="text" class="form-control" name="id_komen" id="id_komen" placeholder="Id Komen" value="<?php echo $id_komen; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <input type="hidden" name="id_balas" value="<?php echo $id_balas; ?>" /> 
	    <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
	    <a href="<?php echo site_url('tbl_balas_komentar') ?>" class="btn btn-default">Cancel</a>
	</form>
    </body>
</html>